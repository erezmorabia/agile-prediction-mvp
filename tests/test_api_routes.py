...
class TestAPIRoutes:
    ...
    def mock_service(self):
        ...
        service.run_backtest = Mock(return_value={
            ...
            'overall_popularity_baseline': 0.3,
            'popularity_gap': 0.4,
            'popularity_improvement_factor': 2.33,
            'overall_precision': 0.5,
            'overall_recall': 0.4,
            'overall_mrr': 0.6,
            'random_precision': 0.13,
            'random_recall': 0.07,
            'random_mrr': 0.18,
            'precision_gap': 0.37,
            'recall_gap': 0.33,
            'mrr_gap': 0.42,
            'precision_improvement_factor': 3.8,
            'recall_improvement_factor': 5.7,
            'mrr_improvement_factor': 3.3,
            'per_month_results': [],
            'teams_tested': 5,
