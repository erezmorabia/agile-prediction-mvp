...
description: System dataset overview: team count, practice count, months, missing values. Use when modifying the Statistics tab, the GET /api/stats response, or practice definition display.
---

# UC-05: View System Statistics

## Summary
User views a snapshot of the loaded dataset: how many teams, practices, and months are included, along with data quality information.
...
4. Missing values section shows total missing entries, which practices and months are affected
5. Practice definitions panel shows level descriptions (Level 0–3 text) if `practice_level_definitions.xlsx` is present
